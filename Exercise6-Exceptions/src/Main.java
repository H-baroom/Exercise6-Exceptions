...
125 mod 24 = 5
        ...
        System.out.println(num1 +" mod "+num2 + " = "+ (num1%num2));
            ...
            System.out.println("the input should be number ");
            input.nextLine();
        }
...
8 x 10 = 80
        ...
        try {
            ...
            multiplay_10(multiplication_num);
        }catch (Exception e){
...
Area is = 176.71458676442586
        ...
        try {
            ...
            System.out.println("should write number ");
            input.nextLine();
        } catch (Exception e) {
            System.out.println("the type of variable is wrong");
            input.nextLine();
        }
...
Reverse word: fasd
        ...
        try {
            ...
            System.out.println("the word should not be null");
            input.nextLine();
        }
...
25 <= 39
        ...
        try {
            ...
            System.out.println("the inputt should be number");
        }
...
2 negatives
        ...
        do {
            ...
            System.out.println("should be input the number ");
            input.nextLine();
        }
...
For example, if the input is 12345, the output should be 54321.
        ...
        try {
            ...
            System.out.println("should be the input is number ");
            input.nextLine();
        }
...
Output: Number of a's: 3
    ...
    public static void multiplay_10(int multiplication_num)throws Exception {
    ...
    public static void index_str(String statement, int index)throws IndexOutOfBoundsException{
        if ( index < statement.length() ) {
            System.out.println("the character in index " + index + " in string " + statement + " is " + statement.charAt(index));
        }else {
            throw new IndexOutOfBoundsException("the index out of bound ");
        }
        }
